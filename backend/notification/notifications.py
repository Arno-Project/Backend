    ...
    def build(self):
        ...
        NotificationBuilder().create_notification(request.customer.normal_user.user,
                                                  ...
                                                  message=f"متخصص با نام "
                                                          f"{request.specialist.normal_user.user.first_name} {request.specialist.normal_user.user.last_name} "
    ...
    def build(self):
        ...
        NotificationBuilder().create_notification(request.specialist.normal_user.user,
                                                  ...
                                                  message=f"شما برای انجام درخواست با شرح "
                                                          f"{request.description} "
                                                          f" توسط مشتری با نام "
                                                          f"{request.customer.normal_user.user.first_name} {request.customer.normal_user.user.last_name} "
                                                          f"تایید شدید. \n",
                                                  type=Notification.NotificationType.INFO,
                                                  link=f"#")
